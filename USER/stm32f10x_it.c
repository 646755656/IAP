...
void USART1_IRQHandler(void)                	//串口1中断服务程序
{
	...
	{     
		...
		COM1.rcv_len++;
		if(COM1.rcv_len >= RCV1_BUFF_LENGH) COM1.rcv_len = 0;
...
void USART2_IRQHandler(void)                	//串口1中断服务程序
{
	...
	{     
		...
		COM2.rcv_len++;
		if(COM2.rcv_len >= RCV2_BUFF_LENGH) COM2.rcv_len = 0;
...
void USART3_IRQHandler(void)
{
	...
	{     
		...
		COM3.rcv_len++;
		if(COM3.rcv_len >= RCV3_BUFF_LENGH) COM3.rcv_len = 0;
...
void UART5_IRQHandler(void)
{
	...
	{     
		...
		COM5.rcv_len++;
		if(COM5.rcv_len >= RCV5_BUFF_LENGH) COM5.rcv_len = 0;
